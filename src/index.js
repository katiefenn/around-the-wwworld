...
window.midiToFrequency = await import('./midi-to-frequency.js').then(m => m.default);
window.createPulseOscillator = await import('./pulse-oscillator.js').then(m => m.default);
