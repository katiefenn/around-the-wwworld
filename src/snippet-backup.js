const createPulseOscillator = await import('http://localhost:8000/src/pulse-oscillator.js').then(m => m.default);
const midiToFrequency = await import('http://localhost:8000/src/midi-to-frequency.js').then(m => m.default);
